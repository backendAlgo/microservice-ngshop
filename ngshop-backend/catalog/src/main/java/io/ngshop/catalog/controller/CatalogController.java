...
public class CatalogController {
    ...
    private String myAppConfiguration;
    @Value("${server.port}")
    ...
    public ResponseEntity<List<Product>> mongoQuery() {
        Query query = Query.query(Criteria.where("price").gt(1500)
                .and("name").ne("123"));
    ...
    public String working() {
        return this.getClass().getName() + " working. " + myAppConfiguration + " " + serverPort;
    }
